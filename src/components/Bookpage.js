    ...
    <>
      <div className="flex justify-end m-5">
        <Link to={"/"}>
          ...
          <button className="p-4 rounded-full bg-white hover:opacity-50">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="h-6 w-6"
              fill="none"
      ...
      <div
        className="m-10 lg:flex lg:flex-row lg:justify-evenly lg:w-3/4"
        id="pdf"
      >
        <img className="lg:w-[25rem]" src={cover} alt="" />
        <div className="flex flex-col gap-10 py-1 m-8 ">
          <p className=" text-3xl font-bold text-white">{bookData.name}</p>
          <p className="text-white">{bookData.details}</p>
